...
void pack_energy_density(double* packed_energy_density,
  ...
  pack_energy_density_kernel<<<nblocks, nthreads>>>(
    packed_energy_density, density, energy_tally, local_nx, local_ny);
...
void unpack_energy_density(double* packed_energy_density,
  ...
  unpack_energy_density_kernel<<<nblocks, nthreads>>>(
   packed_energy_density, energy_tally, local_nx, local_ny);
